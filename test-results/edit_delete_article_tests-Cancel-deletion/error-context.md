...
- banner:
  ...
  - navigation "User account menu":
    ...
    - list:
      ...
      - listitem:
        - link "Log out":
          - /url: /user/logout?token=4FZbRRujGnsoXBczyIGRiQ9q4ql8t3OTRRecm0an6dM
...
- main:
  ...
  - link "Add to Default shortcuts":
    - /url: /admin/config/user-interface/shortcut/manage/default/add-link-inline?link=user/5&name=ahmed&destination=/user/5%3Fcheck_logged_in%3D1&token=EHJJmweK5rwXty8K5Gj3jQ9kt8uTQIjxk26AYVuiHU4
    - text: Add to
    - emphasis: Default
    - text: shortcuts
  - button "Open configuration options"
