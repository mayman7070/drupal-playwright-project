...
- banner:
  ...
  - navigation "User account menu":
    ...
    - list:
      ...
      - listitem:
        - link "Log out":
          - /url: /user/logout?token=Biy-G5T9VfBNIDWu_SK0SJw0FN-LuZrNPs8ym06M6tw
- status:
...
- main:
  ...
  - link "Add to Default shortcuts":
    - /url: /admin/config/user-interface/shortcut/manage/default/add-link-inline?link=node/1&name=Updated%20TitleUpdated%20body&destination=/node/1&token=aYkyBfijgPsa68JSxh9QZC8Zm9PZQtkewGDJ1tCxrog
    - text: Add to
    - emphasis: Default
    - text: shortcuts
  - button "Open configuration options"
