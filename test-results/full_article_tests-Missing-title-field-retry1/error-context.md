...
- main:
  ...
  - link "Add to Default shortcuts":
    - /url: /admin/config/user-interface/shortcut/manage/default/add-link-inline?link=node/add/article&name=Create%20Article&destination=/node/add/article&token=w47cJj4vuKjH9ivnVz5B5_e2wv7xFk5sW-T4W4RPU-I
    - text: Add to
    - emphasis: Default
    - text: shortcuts
  - text: Title *
