...
- banner:
  ...
  - navigation "User account menu":
    ...
    - list:
      ...
      - listitem:
        - link "Log out":
          - /url: /user/logout?token=XYBcW9ZGgG18cS3LEjpYlhtiXgkD2b50FjtwZxR4-JM
- status:
...
- main:
  ...
  - link "Add to Default shortcuts":
    - /url: /admin/config/user-interface/shortcut/manage/default/add-link-inline?link=node/13&name=Invalid%20ImageBad%20image&destination=/node/13&token=OTiA1NukJv8UlSX_kwIzIjN0AHfWAlHta6-dO-Mkha4
    - text: Add to
    - emphasis: Default
    - text: shortcuts
  - button "Open configuration options"
