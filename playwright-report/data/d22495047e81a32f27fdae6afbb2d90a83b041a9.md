...
- main:
  ...
  - link "Add to Default shortcuts":
    - /url: /admin/config/user-interface/shortcut/manage/default/add-link-inline?link=node/1/edit&name=Edit%20Article%20Updated%20TitleUpdated%20body&destination=/node/1/edit&token=MYbe91V1D9oCkuWbWvKvswMVOGSqQDJQwxXpdxWTN0I
    - text: Add to
    - emphasis: Default
    - text: shortcuts
  ...
  - text: "Enter a comma-separated list. For example: Amsterdam, Mexico City, \"Cleveland, Ohio\" Published Last saved: 06/23/2025 - 09:41 Author: ayman"
